...
# --- Adapté (copié depuis generer_pptx_S00.py, même adaptation, 15/09) --------------
# Nom de source Seances/S02bis_Rattrapage-groupes-1-2_Slides.md (pas le
# S02bis_Slides.md que la dérivation par défaut du STEM aurait produit) -- source
# et sortie fixées explicitement plutôt que dérivées, seule adaptation nécessaire ici.
STEM = "S02bis"
SLIDES_MD = os.path.join(HERE, "S02bis_Rattrapage-groupes-1-2_Slides.md")

...
# --- Adapté (LOT C, 14/09) -----------------------------------------------------------
# La consigne enseignant impose le nom de source Seances/S00_Intro-CFD-Helice_Slides.md
# (pas le S00_Slides.md que la dérivation par défaut du STEM aurait produit) -- source
# et sortie fixées explicitement plutôt que dérivées, seule adaptation nécessaire ici.
STEM = "S00"
SLIDES_MD = os.path.join(HERE, "S00_Intro-CFD-Helice_Slides.md")
